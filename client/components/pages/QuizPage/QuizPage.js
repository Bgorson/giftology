...
const Quiz = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      isMulti: true,
      answers: [
        { message: 'Arts and Crafts', value: 'Arts and Crafts' },
        { message: 'Board Games', value: 'Board Games' },
